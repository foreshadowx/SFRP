...
class FG3DPoint_Chair(Dataset):
    ...
    def __init__(self,
                 num_points=1024,
                 data_dir="./data/FG3DPoint/Chair_10000",
                 split='train',
                 transform=None
                 ):
    ...
    # print(self.data_dir)
        ...
        #     self.points[index] = pc_normalize(self.points[index])
                # self.test_points[index] = farthest_point_sample(self.points[index], self.npoints)
        # else:
        #     for index in range(len(self.points)):
        #         print(self.points.shape)
        #         self.points[index] = pc_normalize(self.points[index])
        #         # 用数组保存farthest_point_sample函数的返回值
        #         print(self.points.shape)
